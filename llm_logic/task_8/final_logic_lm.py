...
def logic_solver(nl_problem, context):
    chat_messages = [
        ...
        HumanMessage(
            ...
            Use the following knowledge base as a reference for the syntax and structure: {context}
    ...
    if response.strip() == "Logic Program":
        ...
        if result == "uncertain":
            r_facts, r_query, result, attempts = self_refinement(
                nl_problem_goal, llm_output, result, max_count=6
            )
